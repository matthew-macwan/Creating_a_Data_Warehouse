...
#Load in the downloaded Excel files on the NBA guards we want to put in our data warehouse. 
...
#Chris Paul had 3 different coaches for the last few seasons/Luke Walton took over for the Kings mid season
...
#data/info on each of the coaches 
...
#create columns for Coach dimension and add the data from the above arrays
